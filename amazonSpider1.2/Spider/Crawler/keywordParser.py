...
import time
from Crawler.fieldPatch import field_patch
...
class KwParser(BaseParser):
    ...
    # 是否存在prime
    def _get_prime(self, resultsObj, pr):
        result = ''
        asin_xpath = [
            '//*[@class="a-icon a-icon-prime a-icon-small s-align-text-bottom"]',
            '//*[contains(@class,"a-icon a-icon-prime a-icon-small")]',
        ]
