...
class TosellCrawler(BaseCrawler, Thread):
    ...
    def get_tosell_html_lsit(self, asin, goodsUrl, ua, ip, cookie, referer):
        ...
        self.cookies = None
        goodshtml, cookiesObj, is_error = self.get_html(goodsUrl, ua, ip, cookie, referer, url_type=self.url_type,
                                                        asin=asin)
            ...
            if len(html_list) > 0:
                for html in html_list:
                    ...
                    if is_error:
                        ...
                        analyze = self.analyze_html(html, cookie, cookiesObj, ip, asin, url_dict, cookMd5key, time1,
